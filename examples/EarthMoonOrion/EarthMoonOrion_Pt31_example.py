...
V = [41, 503, 212]
# O: 58º, 50.5º, 9.9º
system = pysamss.System('EarthMoonOrion_Pt31')
launch_time = datetime.datetime(2022, 11, 16, 6, 47, 44)
time_delta = datetime.timedelta(days=5, hours=4, minutes=0)
...
# Results:
# Earth - Orion: 232905.30968966978 [miles]
# Moon - Orion: 3105.8241535327606 [miles]
# P: [-210241.39613701 -102331.94541519  -37832.7010554 ] [miles]
# V: [ 63.94807649 999.95549086 455.05793452] [miles/hour]