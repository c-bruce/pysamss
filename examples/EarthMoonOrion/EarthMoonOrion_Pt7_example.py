...
V = [-2400, -1341, -525]
# O: 53º, 53.5º, 18.0º
system = pysamss.System('EarthMoonOrion_Pt7')
launch_time = datetime.datetime(2022, 11, 16, 6, 47, 44)
time_delta = datetime.timedelta(days=1, hours=6, minutes=5)
...
# Results:
# Earth - Orion: 143635.8168769933 [miles]
# Moon - Orion: 162196.87710044332 [miles]
# P: [-140631.8573828   -43594.00824415  -10315.0703271 ] [miles]
# V: [-2157.69129352 -1246.78481611  -497.40533683] [miles/hour]