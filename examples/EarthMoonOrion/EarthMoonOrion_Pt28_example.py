...
V = [57, 74, -2]
# O: 56º, 49.4º, 4.6º
system = pysamss.System('EarthMoonOrion_Pt28')
launch_time = datetime.datetime(2022, 11, 16, 6, 47, 44)
time_delta = datetime.timedelta(days=5, hours=1, minutes=0)
...
# Results:
# Earth - Orion: 233687.873572246 [miles]
# Moon - Orion: 10886.040256784168 [miles]
# P: [-210387.86595873 -103637.81156708  -38367.56145552] [miles]
# V: [ 41.94099892 182.25170365  53.22393678] [miles/hour]