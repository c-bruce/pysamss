...
V = [-6657, -1993, -441]
# O: 59º, 48.9º, 13.0º
system = pysamss.System('EarthMoonOrion_Pt1')
launch_time = datetime.datetime(2022, 11, 16, 6, 47, 44)
time_delta = datetime.timedelta(hours=6, minutes=5)
...
# Results:
# Earth - Orion: 61102.10258927134 [miles]
# Moon - Orion: 202045.76621301303 [miles]
# P: [-64596.40549525  -7266.35058931   2723.91074462] [miles]
# V: [-4895.47960603 -1906.98847747  -580.37085092] [miles/hour]
