...
# Step 1: Setup system
# Mission Time: 1 days, 14  hrs, 5  min
# Orion is 153,130 miles from Earth, 156,720 miles from the Moon, cruising at 2,356 miles per hour.
P = [-148893, -48542, -12314]
V = [-1965, -1204, -492]
# O: 9º, 73.3º, 39.1º
system = pysamss.System('EarthMoonOrion_Pt9')
launch_time = datetime.datetime(2022, 11, 16, 6, 47, 44)
time_delta = datetime.timedelta(days=1, hours=14, minutes=5)
...
# Results:
# Earth - Orion: 161854.03136278267 [miles]
# Moon - Orion: 151248.49743958339 [miles]
# P: [-156387.37820549  -53233.73541446  -14249.11766297] [miles]
# V: [-1778.42248594 -1119.23354924  -464.06125132] [miles/hour]