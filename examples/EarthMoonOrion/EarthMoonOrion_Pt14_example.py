...
V = [-1217, -929, -412]
# O: 49º, 51.6º, 10.9º
system = pysamss.System('EarthMoonOrion_Pt14')
launch_time = datetime.datetime(2022, 11, 16, 6, 47, 44)
time_delta = datetime.timedelta(days=2, hours=10, minutes=6)
...
# Results:
# Earth - Orion: 196210.92240471035 [miles]
# Moon - Orion: 122108.6962649733 [miles]
# P: [-184808.18688578  -73389.42493701  -22974.4635626 ] [miles]
# V: [-1097.77285288  -855.78936289  -383.91339188] [miles/hour]