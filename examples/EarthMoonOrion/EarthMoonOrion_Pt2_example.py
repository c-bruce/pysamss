...
V = [-4918, -1844, -547]
# O: 63º, 45.4º, 350.5º
system = pysamss.System('EarthMoonOrion_Pt2')
launch_time = datetime.datetime(2022, 11, 16, 6, 47, 44)
time_delta = datetime.timedelta(hours=10, minutes=5)
...
# Results:
# Earth - Orion: 79573.33489611694 [miles]
# Moon - Orion: 192895.41518255902 [miles]
# P: [-82321.67313527 -14156.30718921    592.5212323 ] [miles]
# V: [-4008.18282694 -1696.94853488  -559.99544218] [miles/hour]
