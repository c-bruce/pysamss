...
# Step 1: Setup system
# Mission Time: 2 days, 18  hrs, 6  min
# Orion is 201,510 miles from Earth, 115,821 miles from the Moon, cruising at 1,349 miles per hour.
P = [-188983, -76817, -24534]
V = [-990, -833, -382]
# O: 51º, 51.3º, 11.8º
system = pysamss.System('EarthMoonOrion_Pt16')
launch_time = datetime.datetime(2022, 11, 16, 6, 47, 44)
time_delta = datetime.timedelta(days=2, hours=18, minutes=6)
...
# Results:
# Earth - Orion: 206355.68909570255 [miles]
# Moon - Orion: 109419.51488067623 [miles]
# P: [-192732.46418245  -80054.86938479  -26030.37422365] [miles]
# V: [-885.67285977 -761.78818802 -353.63613946] [miles/hour]