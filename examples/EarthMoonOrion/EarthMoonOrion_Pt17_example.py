...
V = [-886, -787, -366]
# O: 53º, 51.2º, 12.2º
system = pysamss.System('EarthMoonOrion_Pt17')
launch_time = datetime.datetime(2022, 11, 16, 6, 47, 44)
time_delta = datetime.timedelta(days=2, hours=22, minutes=6)
...
# Results:
# Earth - Orion: 216384.9473185021 [miles]
# Moon - Orion: 93081.65347125872 [miles]
# P: [-200215.28803039  -87180.09947697  -29407.74876303] [miles]
# V: [-654.61287844 -650.37092575 -313.93343618] [miles/hour]