...
# Step 1: Setup system
# Mission Time: 1 days, 18  hrs, 5  min
# Orion is 161,854 miles from Earth, 151,227 miles from the Moon, cruising at 2,173 miles per hour.
P = [-156387, -53233, -14249]
V = [-1785, -1143, -476]
# O: 52º, 45.7º, 8.0º
system = pysamss.System('EarthMoonOrion_Pt10')
launch_time = datetime.datetime(2022, 11, 16, 6, 47, 44)
time_delta = datetime.timedelta(days=1, hours=18, minutes=5)
