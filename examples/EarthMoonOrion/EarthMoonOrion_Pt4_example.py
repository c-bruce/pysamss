...
V = [-3438, -1605, -567]
# O: 32º, 2.0º, 341.4º
system = pysamss.System('EarthMoonOrion_Pt4')
launch_time = datetime.datetime(2022, 11, 16, 6, 47, 44)
time_delta = datetime.timedelta(hours=18, minutes=5)
...
# Results:
# Earth - Orion: 109405.9163134042 [miles]
# Moon - Orion: 179196.4542859973 [miles]
# P: [-110028.40788355  -27015.90239861   -3929.26161008] [miles]
# V: [-2998.97597113 -1484.37592989  -544.9489182 ] [miles/hour]