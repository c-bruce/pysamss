...
# Step 1: Setup system
# Mission Time: 4 days, 20  hrs, 41  min
# Orion is 233,847 miles from Earth, 22,818 miles from the Moon, cruising at 168 miles per hour.
P = [-210645, -103567, -38130]
V = [29, -130, -101]
# O: 51º, 51.0º, 10.0º
system = pysamss.System('EarthMoonOrion_Pt27')
launch_time = datetime.datetime(2022, 11, 16, 6, 47, 44)
time_delta = datetime.timedelta(days=4, hours=20, minutes=41)
...
# Results:
# Earth - Orion: 233787.1630165316 [miles]
# Moon - Orion: 13237.495858418579 [miles]
# P: [-210442.46860825 -103749.16666282  -38382.27697335] [miles]
# V: [44.18708328 95.53203356 10.72657202] [miles/hour]